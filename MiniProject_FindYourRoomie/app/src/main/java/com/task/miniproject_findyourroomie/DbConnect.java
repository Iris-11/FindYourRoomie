...
public class DbConnect extends SQLiteOpenHelper {
    private static final String dbName = "FindMyRoomie";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "create table " + dbTable + "("+ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+username+" TEXT, "+email+" TEXT, "+password+" BLOB, "+salt+" BLOB, "+
                col_name+ " TEXT , " +
                col_gender+ " TEXT, "+
                col_dob+ " TEXT, "+
                col_contact + " TEXT , "+
